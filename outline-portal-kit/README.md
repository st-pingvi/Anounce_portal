...
Дизайн-kit обновлен по брендбуку из файла [Брендбук МД.pdf](/Users/johndoe/Documents/МД/Документы/Брендбук%20МД.pdf).

Подтвержденные правила:

- приоритетное фирменное написание `Московское долголетие` — бордовым цветом;
- основные цвета: изумрудный, бирюзовый, рубиновый, красный, белый;
- основной шрифт: `Circe`;
- допустимы цветовые сочетания из основной палитры;
- для афиш и интерфейсов рекомендованы крупные, чистые блоки без визуального шума.
