...
- цвета брендбука:
  `#165849`, `#2EB398`, `#800036`, `#BD536D`, `#FFFFFF`;
...
Брендбук уже учтен. При следующем этапе нужно только:

- получить исходники логотипа и фирменного написания;
- установить шрифт `Circe` на дизайн-машины и в Canva;
- перенести точные брендовые шаблоны афиш в production.
